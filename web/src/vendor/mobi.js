// MOBI / KF8 (AZW3) parser, vendored from foliate-js.
//
//   source:  https://github.com/johnfactotum/foliate-js/blob/main/mobi.js
//   license: MIT — Copyright (c) 2022 John Factotum (see LICENSE-mobi.txt)
//
// Vendored rather than installed: the only npm publication of foliate-js is an
// unofficial re-upload by a third party, and this file has no dependencies of
// its own beyond an `unzlib` function passed to the constructor. Kept verbatim
// so it can be diffed against upstream — dot-lib code lives in mobi-to-epub.ts.
